...
const RegisterForm = ({ isLogin }: IProps) => {
    return (
        <div className={`order-1 md:order-2 flex flex-col justify-center gap-10 p-3 ${isLogin ? "opacity-0 h-64" : "opacity-100"}`}>
            ...
            <form action="" className="flex flex-col gap-5">
                <div className="flex flex-col gap-1">
                    <label htmlFor="name" className="text-xl font-semibold">Username</label>
                    <input type="text" placeholder="khairy" name="name" id="name"
