    ...
    return (
        <main className="section-gap relative z-100">
            <div className="container flex flex-col gap-5">
                ...
                <p data-aos="fade-right" className="mb-1 text-xl text-white/60">Zedny is a subscription-based e-learning platform where all learning resources, including video courses, book summaries, and written materials, are pre-prepared and accessible to users at any time. Given that the courses are pre-recorded and designed for self-paced learning, Zedny’s attendance policy is adapted to suit the platform’s virtual nature.</p>

                <p data-aos="fade-right" className="mb-1 text-xl text-white/70 first-char">
                ...
                <p data-aos="fade-right" className="mb-1 text-xl text-white/70">
