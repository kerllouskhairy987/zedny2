        ...
        <div className="p-5 ps-10 flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-4 p-4 rounded-lg bg-[#0B111D]">
                ...
                <div className="flex flex-wrap gap-4">
                    {
                        data2.map((item, idx) => (
                            <div key={idx} className="flex grow justify-between items-start gap-4 bg-white/10 rounded-md p-5 border border-transparent hover:border-[#00C2FF] hover:scale-105 hover:rotate-1 duration-300">
