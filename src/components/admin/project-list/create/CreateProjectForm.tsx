...
import { CreateActionState, CreateNewProject } from "@/server/admin/project-list/create/action";
...
const CreateProjectForm = () => {
    ...
    const [state, action, isPending] = useActionState(CreateNewProject, initialState)
            ...
            <form action={action} className="w-full md:max-w-150 mx-auto mt-10 flex flex-col gap-5 p-5 bg-[#0B111D] rounded-lg">
                ...
                <div className="flex flex-col gap-1 ">
                    ...
                    <input type="text" name="desc"
                        className="bg-transparent py-2 px-3 border-[0.01px] border-[#47BFEB] rounded-lg"
                        defaultValue={state.formData.get("desc") as string}
