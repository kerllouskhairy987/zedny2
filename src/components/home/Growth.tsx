...
const Growth = () => {
    return (
        <section className="container pb-10 md:pb-20">
            <div data-aos="fade-right" className="flex flex-col mx-auto text-center gap-3 max-w-[540]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10 overflow-x-hidden">
                {/* <div className="grid grid-cols-1 md:grid-cols-2 gap-5"> */}
                <div data-aos="fade-right" className="group relative parent-line-animate overflow-hidden flex flex-col gap-2 bg-[#1B1B1B] p-5 rounded-md hover:-translate-y-3 border-b-[0.01px] border-r-[0.01px] border-[#dd429291] shadow-xs hover:shadow-lg shadow-[#dd4292b0] duration-300">
                ...
                <div data-aos="fade-up" className="group relative parent-line-animate overflow-hidden flex flex-col gap-2 bg-[#1B1B1B] p-5 rounded-md hover:-translate-y-3 border-b-[0.01px] border-r-[0.01px] border-[#dd429291] shadow-xs hover:shadow-lg shadow-[#dd4292b0] duration-300">
                    <span className="line-animate"></span>
                ...
                <div data-aos="fade-left" className="group relative parent-line-animate overflow-hidden flex flex-col gap-2 bg-[#1B1B1B] p-5 rounded-md hover:-translate-y-3 duration-300 border-b-[0.01px] border-r-[0.01px] border-[#dd429291] shadow-xs hover:shadow-lg shadow-[#dd4292b0]">
                    <span className="line-animate"></span>
